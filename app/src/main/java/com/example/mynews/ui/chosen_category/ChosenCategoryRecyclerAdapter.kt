...
import com.example.mynews.ui.news.NewsRecyclerAdapter

class ChosenCategoryRecyclerAdapter(private var articles: MutableList<Article>, private val clickListener: ClickListener) :
